...
all:
	gcc imread.c -o a.out -I . -std=gnu99
...
rundemofrac:
	...
	cd $(OUTPUT_BINDIR); optirun ./demo_$(FRACTAL_NAME)

rundemocam:
	cd $(OUTPUT_BINDIR); optirun ./demo_$(CAM_NAME)
...
runtestcam:
	cd $(OUTPUT_BINDIR); optirun ./$(TESTCAM_NAME)
